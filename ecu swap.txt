...
VF750 EFI swap links

1. EFI swapping VF750 (GSXR throttle bodies)
   - https://forum.vf1000.com/t/efi-swapping-my-interceptor/5487
   Plan: use GSXR750 throttle bodies and split them into a 2+2 layout for the V4.

2. Converting carbs to fuel injection (VF750 Sabre)
   - https://v4musclebike.com/threads/converting-carbs-to-fuel-injection.44405/
...
3. EFI conversion discussion for Honda V4 (Megasquirt)
   - https://forum.vf1000.com/t/efi-conversion/1856
   Idea:
...
4. VF750 EFI discussions (general list)
   - https://forum.vf1000.com/c/vf750/12
   Category that includes EFI and swap-related threads.

Real EFI directions found for the VF750

Option 1 - Individual throttle bodies (most common)
...
Option 4 - Scooter throttle bodies (popular DIY route)
...
5. Old charging system is not very strong
...
Most interesting compact VF750 solution
