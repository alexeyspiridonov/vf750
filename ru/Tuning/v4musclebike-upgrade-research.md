...
- Подход Speeduino/Megasquirt возможен, но это долгий инженерный проект, а не апгрейд на выходные.
...
- Для практичного мотоцикла под езду сначала восстановить и настроить карбюраторы.
...
- Современный передок от спортбайка — это кастомный проект: шток, траверсы, подшипники, ограничители, колесо, тормоза, приборка, фара и органы управления.
...
- [1982-83 V45 Sabre Cafe Racer Build](https://v4musclebike.com/threads/1982-83-v45-sabre-cafe-racer-build.34759/) — тема сборки Balkan Moto V45 Sabre. Важные детали: переход на более живой донор, современные пульты управления, решение проблем проводки, приоритет дорожной пригодности и предупреждение о зазоре задней шины до хвостовой рамки.
- [Newbie's '84 V65 Sabre](https://v4musclebike.com/threads/newbies-84-v65-sabre.25947/) — полная тема сборки Sugarkryptonite: стадия streetfighter, передок R1, задняя рама, амортизатор Blackbird, покраска двигателя, карбы, синхронизация, проводка, охлаждение и исправления после сборки.
- [GONE Custom cafe racer Honda V65 Sabre](https://v4musclebike.com/threads/custom-cafe-racer-honda-v65-sabre.35922/) — краткое резюме того же V65-проекта: передок R1, амортизатор Blackbird, клипоны, упрощённая проводка, кастомные кронштейны фары, электронный спидометр, бачок охлаждения, тормоза и обслуживание редуктора.
- [1984 v65 magna fork swap](https://v4musclebike.com/forums/showthread.php?t=8142) — не готовая cafe-сборка, но полезное раннее обсуждение вариантов bobber, cafe racer, drag bike и streetfighter из деталей Sabre/Magna.

### Практические выводы

- Начинать с максимально живого донора. Плохой донор быстро превращается в источник деталей.
...
- [Carb tuning](https://v4musclebike.com/threads/carb-tuning.48630/) — свежий кейс по `1984 V30`: после поездки одна труба посинела, свеча стала беловатой, но мотор заводился, держал холостой ход и ехал нормально. Практический вывод: сначала подтвердить синхронизацию, затем пробовать idle-drop по смеси; если малый диапазон винта качества не исправляет перегрев, искать частично забитые каналы и чистить/перебирать карб.
...
- Синяя выпускная труба и белая свеча на одном цилиндре — не косметика. Подтвердите температуру ИК-термометром; если регулировка смеси не помогает, не продолжайте ездить до чистки/проверки карба.
