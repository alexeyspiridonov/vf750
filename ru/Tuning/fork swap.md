...
### 4. Фара, приборы и замок зажигания становятся работой по изготовлению деталей
...
Лучше всего подходит, если цель — радикальная современная cafe/streetfighter-сборка.
...
- V65/R1-сборка полезна как процессный пример: кастомный передок тянет за собой тормоза, органы управления, фару, приборы и повторную проверку подшипников.
