...
Condensed from the repo's current working notes for the VF750 V45 family.

## Removal

- Drain fuel and remove the tank.
...
- Warm the engine fully before syncing.
- Connect vacuum gauges or a 4-column manometer to all four intake ports.
- Adjust the sync screws between carb bodies until vacuum is balanced bank-to-bank and cylinder-to-cylinder.
- Recheck idle speed after synchronization.

## Diaphragms And Air Leaks
